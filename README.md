...
1. نزّل أحدث مثبّت من صفحة [الإصدارات (Releases)](https://github.com/m4u05999/Satr/releases).
...
1. **نزّل نسخة `.zip`** من صفحة الإصدارات بدل `.exe` — تمرّ من الحاجز غالباً، ثم فُكّ
   الضغط وشغّل المثبّت بداخلها.
