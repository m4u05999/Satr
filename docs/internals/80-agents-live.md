...
أحد عشر فحصاً: صفٌّ واحد عبر الاستئناف مع عدّاده · الشارات الثماني بنصّها · REPLACE
(«يُحسم…» ثم الخاتمة) · «ينتظر إذنك» وزوالها بالمعرّف الصحيح دون الخاطئ · زر الإيقاف
يبثّ ويعود عند `failStop` · الاختفاء التام بارتفاع مقيس · **رسوّ الاتجاه بالبكسل** عبر
`Range` لا `getComputedStyle` · رفض المعرّفات المشوّهة وقصّ 300 · حدّ الخمسين · صفر CSP.
