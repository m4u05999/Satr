...
function executionPolicy(engine) {
  ...
  return [
    ...
    '- لتوليد الصور/الفيديو استخدم أداة generate_media الداخلية حصراً (كلفة شفافة قبل التنفيذ وسجل معرض 🖼)؛ لا تستعمل موصّل توليد خارجياً مثل Higgsfield إلا إن سمّاه المستخدم صراحةً في طلبه.',
  ].join('\n');
}
