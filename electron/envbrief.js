...
const SUBAGENT_NAMING_LINE = 'صدق تسمية الوكلاء الفرعيين: وكلاؤك الفرعيون هم أنت '
  ...
  + 'رأي نماذج حقيقية متعددة فوجّهه إلى مهارة satr-diverge أو عصف غرفة العمليات '
  + '(محرّكان مستقلان فعلاً)، أو شغّل المحرّك الآخر من الطرفية المرئية وقل إن هذا ما فعلته.';
