...
- **⚠️ تحذير upstream جديد رُصد أثناء الجسّ**: `CLAUDE_SDK_CAN_USE_TOOL_SHADOWED` ظهر في
  ...
  وهي غير مرئية له** — وسطر يضبط `settingSources:['user','project','local']`، فمشروعٌ
  يحمل `.claude/settings.json` بقواعد سماح قد يُمرّر أداةً قبل مربع الإذن العربي.
  مسجَّل في `OBS-140` ولم يُقَس بعد.
