...
المحرّر ويرسلها لاحقاً عبر `send()` نفسه. **حدّ صريح**: عند استئناف جلسة Claude لا يحدث
rollback لسياق الخادم ولا تفريع حقيقي؛ الرسالة الجديدة تُضاف إلى السياق القائم.
...
- **حرّر وأعد الإرسال**: قلم رسالة المستخدم يعيد نصّها وصورها إلى المؤلّف ويعلّم الأصل
  «مُعدَّلة/متجاوَزة». هذه راحة نسخ/تحرير فقط؛ لا rollback ولا تفريع جلسة حقيقي.
