...
electron/sessionmeta.js ← ميتاداتا جانبية لتثبيت الجلسات وتسميتها تحت
                       ~/.satr/session-meta.json: get/set/remove، سقف 500، عنوان منقّى
                       ≤80 محرفاً، وكتابة ذرية أفضل جهد؛ لا يلمس مخازن الجلسات الأصلية
