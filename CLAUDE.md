...
### الطرفية العربية المدمجة (المرحلة 8 — قيد التنفيذ، 8.1 منجزة)

> التصميم الكامل والقرارات المثبّتة في `docs/PHASE8-DESIGN.md` — اقرأه قبل أي عمل على 8.2+.
> المعمارية: نسخة xterm.js حقيقية **واحدة** (محرك الحالة) + عارضان (BiDi HTML افتراضياً،
> الشبكة للشاشة البديلة). في 8.1 يوجد عارض xterm.js القياسي فقط (بلا عربية بعد — مقصود).
