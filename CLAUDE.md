...
- **خفض كلفة لقطات النموذج (OBS-016 — 2026-09-03)**: مسار النموذج وحده يطلب
  `modelImage:true`؛ فتُصغّر `NativeImage` بنسبة ثابتة إلى ضلع أطول أقصاه
  `SHOT_MAX_EDGE=1280` ثم تُرمّز JPEG بجودة `SHOT_JPEG_QUALITY=72`، وتبقى
  `page_metrics` مع اللقطة الكاملة. مصغّرة المستخدم `agent_screenshot` ومسار تحديد
  العنصر المرئي بقيا PNG بلا تغيير. على fixture الحي نفسه انخفضت الكاملة
  1,903,731→119,217 بايت (93.7%)، والعنصر 853,149→80,756 (90.5%)، ونافذة العرض
  873,108→83,138 (90.5%). الوصف والموجز يفرضان `browser_snapshot` للبنية أولاً
  ويحصران الصورة البصرية في الحكم على التخطيط؛ حارس Electron يفحص JPEG ‏`FFD8`
  والسقف وPNG المصغّرة ≤360px/512KiB.
