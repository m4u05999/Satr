...
- **تسجيل فيديو التصفح (م-5 — طلب مالك)**: زرّ ⏺ يسجّل جلسة المعاينة webm قابل للتنزيل
  ...
  (نمط تصدير 4.8 — لا CSP جديد). يسجّل العرض وحده؛ الإغلاق يوقف وينزّل. حدّ: webm فقط
  (mp4 يحتاج ffmpeg — خارج التموضع).
