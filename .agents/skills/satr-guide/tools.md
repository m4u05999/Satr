...
- **`screenshot`** — لقطة JPEG مضغوطة للمعاينة. ابدأ بـ browser_snapshot للبنية؛ الصورة للحكم على التخطيط فقط. لوحة «سطر» أضيق وأقصر: full_page=true للصفحة كاملة، أو browser_set_viewport لمقاس بعينه.
- **`browser_screenshot_element`** — لقطة JPEG مضغوطة لعنصر بـ ref من browser_snapshot أو مُحدِّد CSS؛ أوفر من الصفحة كاملة. قراءة فقط.
