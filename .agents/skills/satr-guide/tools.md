...
- **`screenshot`** — التقط لقطة شاشة للصفحة المعروضة في المعاينة لتراها بصرياً وتتحقق من مظهرها. لوحة معاينة «سطر» أضيق وأقصر من متصفح عادي؛ للحكم على تخطيط صفحة كاملة مرّر full_page=true أو اضبط browser_set_viewport أولاً. تعيد صورة PNG.
