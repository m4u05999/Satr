...
paths:
  ...
  - "electron/conversations.js"
  - "electron/conversation-bridge.js"
  - "electron/chats.js"
...
- `docs/internals/05-claude-sdk-background-tasks.md` — مهام Claude SDK الخلفية (دفعة D — 2026-07-26) وبنود الجوال OBS-147/148
- `docs/internals/06-claude-sdk-polish.md` — تلميع محرك Claude Agent SDK (دفعة E — 2026-07-27)
- `docs/internals/07-session-continuity.md` — استمرارية المحادثة والجلسة (2026-09-10)
